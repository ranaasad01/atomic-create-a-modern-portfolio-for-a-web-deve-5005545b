          ...
          >
            <TiltCard className="relative">
              ...
              <motion.div
                ...
                className="absolute top-1/2 -right-10 -translate-y-1/2 flex items-center gap-1.5 px-2.5 py-1.5 rounded-full border border-rose-500/30 bg-rose-500/10 backdrop-blur-md"
