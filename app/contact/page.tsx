...
function FloatingInput({
  ...
  const baseClass =
    ...
    (error
      ? "border-blue-500/60 focus:border-blue-500 focus:shadow-[0_0_0_3px_rgba(239,68,68,0.15)]"
      : focused
      ...
      <AnimatePresence>
        {error && (
          <motion.p
            ...
            className="mt-1.5 text-xs text-blue-400 flex items-center gap-1"
          >
            <AlertCircle size={11} />
            {error}
          </motion.p>
                  ...
                  {status === "success" ? (
                    ...
                    >
                      <motion.div
                        ...
                        className="flex h-20 w-20 items-center justify-center rounded-full bg-blue-500/15 border border-blue-500/30 mb-6"
                      >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="px-2 py-0.5 rounded-full bg-blue-500/15 border border-blue-500/25 text-blue-400 text-[10px] font-semibold uppercase tracking-wider">
                      Active
                    </span>
                  </div>
